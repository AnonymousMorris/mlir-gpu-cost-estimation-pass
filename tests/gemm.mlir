module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel   {
    gpu.func @test_kernel(%A: memref<4096x4096xf16>, %B: memref<4096x4096xf16>, %C: memref<4096x4096xf16>) kernel  {
      ...
      %B_sg_prefetch_offset_x_plus_32 = arith.addi %B_sg_prefetch_offset_x, %c32 : index
      ...
      xegpu.prefetch_nd %B_sg_prefetch_tile[%B_sg_prefetch_offset_x, %B_sg_prefetch_offset_y] {l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>} : !xegpu.tensor_desc<8x16xf16, #xegpu.block_tdesc_attr<array_length = 2>>
      // stage 2 (move 32 elements in the x direction and prefetch next 8x32 tile)
      xegpu.prefetch_nd %B_sg_prefetch_tile[%B_sg_prefetch_offset_x_plus_32, %B_sg_prefetch_offset_y] {l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>} : !xegpu.tensor_desc<8x16xf16, #xegpu.block_tdesc_attr<array_length = 2>>
      // stage 3
      xegpu.prefetch_nd %B_sg_prefetch_tile[%B_sg_prefetch_offset_x_plus_64, %B_sg_prefetch_offset_y] {l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>} : !xegpu.tensor_desc<8x16xf16, #xegpu.block_tdesc_attr<array_length = 2>>
      ...
      // create B tiles
      %B_tile = xegpu.create_nd_tdesc %B : memref<4096x4096xf16> -> !xegpu.tensor_desc<32x16xf16, #xegpu.block_tdesc_attr<array_length = 2>>
      ...
      %c_init_val_0_1 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_0_2 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_0_3 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_1_0 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_1_1 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_1_2 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_1_3 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_2_0 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_2_1 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_2_2 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_2_3 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_3_0 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_3_1 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_3_2 = arith.constant dense<0.0> : vector<8xf32>
      %c_init_val_3_3 = arith.constant dense<0.0> : vector<8xf32>
      ...
      %k_loop_result:16 = scf.for %k = %c0 to %c4096 step %c32 iter_args (
        ...
        // load B tiles
        %b_val_arr_0_t0 = xegpu.load_nd %B_tile[%k, %C_sg_tile_offset_y]{packed, l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>} : !xegpu.tensor_desc<32x16xf16, #xegpu.block_tdesc_attr<array_length = 2>> -> vector<64xf16>
        %b_val_arr_0 = vector.shape_cast %b_val_arr_0_t0 : vector<64xf16> to vector<2x32xf16>

        %b_val_arr_1_t0 = xegpu.load_nd %B_tile[%k, %C_sg_tile_offset_y_plus_32_t0] {packed, l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>} : !xegpu.tensor_desc<32x16xf16, #xegpu.block_tdesc_attr<array_length = 2>> -> vector<64xf16>
        %b_val_arr_1 = vector.shape_cast %b_val_arr_1_t0 : vector<64xf16> to vector<2x32xf16>

        %b_val_0 = vector.extract %b_val_arr_0 [0] : vector<32xf16> from vector<2x32xf16>
        %b_val_1 = vector.extract %b_val_arr_0 [1] : vector<32xf16> from vector<2x32xf16>
        %b_val_2 = vector.extract %b_val_arr_1 [0] : vector<32xf16> from vector<2x32xf16>
        %b_val_3 = vector.extract %b_val_arr_1 [1] : vector<32xf16> from vector<2x32xf16>
        ...
        xegpu.prefetch_nd %B_sg_prefetch_tile[%B_prefetch_offset_x,  %B_sg_prefetch_offset_y] {l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>} : !xegpu.tensor_desc<8x16xf16, #xegpu.block_tdesc_attr<array_length = 2>>


        %a_val_0_0 = vector.extract_strided_slice %a_val_0 { offsets = [0], sizes = [8], strides = [1]} :
          vector<32xf16> to vector<8xf16>
        ...
        %b_val_0_0 = vector.extract_strided_slice %b_val_0 { offsets = [0], sizes = [16], strides = [1]} :
          vector<32xf16> to vector<16xf16>
        ...
        // do DPAS
        %new_c_val_0_0_temp = xegpu.dpas %a_val_0_0, %b_val_0_0, %c_val_0_0 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_0_0 = xegpu.dpas %a_val_0_1, %b_val_1_0, %new_c_val_0_0_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_1_0_temp = xegpu.dpas %a_val_1_0, %b_val_0_0, %c_val_1_0 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_1_0 = xegpu.dpas %a_val_1_1, %b_val_1_0, %new_c_val_1_0_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_2_0_temp = xegpu.dpas %a_val_2_0, %b_val_0_0, %c_val_2_0 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_2_0 = xegpu.dpas %a_val_2_1, %b_val_1_0, %new_c_val_2_0_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_3_0_temp = xegpu.dpas %a_val_3_0, %b_val_0_0, %c_val_3_0 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_3_0 = xegpu.dpas %a_val_3_1, %b_val_1_0, %new_c_val_3_0_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>

        %new_c_val_0_1_temp = xegpu.dpas %a_val_0_0, %b_val_0_1, %c_val_0_1 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_0_1 = xegpu.dpas %a_val_0_1, %b_val_1_1, %new_c_val_0_1_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_1_1_temp = xegpu.dpas %a_val_1_0, %b_val_0_1, %c_val_1_1 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_1_1 = xegpu.dpas %a_val_1_1, %b_val_1_1, %new_c_val_1_1_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_2_1_temp = xegpu.dpas %a_val_2_0, %b_val_0_1, %c_val_2_1 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_2_1 = xegpu.dpas %a_val_2_1, %b_val_1_1, %new_c_val_2_1_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_3_1_temp = xegpu.dpas %a_val_3_0, %b_val_0_1, %c_val_3_1 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_3_1 = xegpu.dpas %a_val_3_1, %b_val_1_1, %new_c_val_3_1_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>

        %new_c_val_0_2_temp = xegpu.dpas %a_val_0_0, %b_val_0_2, %c_val_0_2 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_0_2 = xegpu.dpas %a_val_0_1, %b_val_1_2, %new_c_val_0_2_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_1_2_temp = xegpu.dpas %a_val_1_0, %b_val_0_2, %c_val_1_2 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_1_2 = xegpu.dpas %a_val_1_1, %b_val_1_2, %new_c_val_1_2_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_2_2_temp = xegpu.dpas %a_val_2_0, %b_val_0_2, %c_val_2_2 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_2_2 = xegpu.dpas %a_val_2_1, %b_val_1_2, %new_c_val_2_2_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_3_2_temp = xegpu.dpas %a_val_3_0, %b_val_0_2, %c_val_3_2 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_3_2 = xegpu.dpas %a_val_3_1, %b_val_1_2, %new_c_val_3_2_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>

        %new_c_val_0_3_temp = xegpu.dpas %a_val_0_0, %b_val_0_3, %c_val_0_3 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_0_3 = xegpu.dpas %a_val_0_1, %b_val_1_3, %new_c_val_0_3_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_1_3_temp = xegpu.dpas %a_val_1_0, %b_val_0_3, %c_val_1_3 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_1_3 = xegpu.dpas %a_val_1_1, %b_val_1_3, %new_c_val_1_3_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_2_3_temp = xegpu.dpas %a_val_2_0, %b_val_0_3, %c_val_2_3 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_2_3 = xegpu.dpas %a_val_2_1, %b_val_1_3, %new_c_val_2_3_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_3_3_temp = xegpu.dpas %a_val_3_0, %b_val_0_3, %c_val_3_3 : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
        %new_c_val_3_3 = xegpu.dpas %a_val_3_1, %b_val_1_3, %new_c_val_3_3_temp : vector<8xf16>, vector<16xf16>, vector<8xf32> -> vector<8xf32>
      ...
      // trunc to f16
      %c_result_0_0_f16 = arith.truncf %k_loop_result#0 : vector<8xf32> to vector<8xf16>
      %c_result_0_1_f16 = arith.truncf %k_loop_result#1 : vector<8xf32> to vector<8xf16>
      %c_result_0_2_f16 = arith.truncf %k_loop_result#2 : vector<8xf32> to vector<8xf16>
      %c_result_0_3_f16 = arith.truncf %k_loop_result#3 : vector<8xf32> to vector<8xf16>
      %c_result_1_0_f16 = arith.truncf %k_loop_result#4 : vector<8xf32> to vector<8xf16>
      %c_result_1_1_f16 = arith.truncf %k_loop_result#5 : vector<8xf32> to vector<8xf16>
      %c_result_1_2_f16 = arith.truncf %k_loop_result#6 : vector<8xf32> to vector<8xf16>
      %c_result_1_3_f16 = arith.truncf %k_loop_result#7 : vector<8xf32> to vector<8xf16>
      %c_result_2_0_f16 = arith.truncf %k_loop_result#8 : vector<8xf32> to vector<8xf16>
      %c_result_2_1_f16 = arith.truncf %k_loop_result#9 : vector<8xf32> to vector<8xf16>
      %c_result_2_2_f16 = arith.truncf %k_loop_result#10 : vector<8xf32> to vector<8xf16>
      %c_result_2_3_f16 = arith.truncf %k_loop_result#11 : vector<8xf32> to vector<8xf16>
      %c_result_3_0_f16 = arith.truncf %k_loop_result#12 : vector<8xf32> to vector<8xf16>
      %c_result_3_1_f16 = arith.truncf %k_loop_result#13 : vector<8xf32> to vector<8xf16>
      %c_result_3_2_f16 = arith.truncf %k_loop_result#14 : vector<8xf32> to vector<8xf16>
      %c_result_3_3_f16 = arith.truncf %k_loop_result#15 : vector<8xf32> to vector<8xf16>
      ...
      // row 1
      %c_sg_tile = xegpu.create_nd_tdesc %C : memref<4096x4096xf16> -> !xegpu.tensor_desc<8x16xf16>
